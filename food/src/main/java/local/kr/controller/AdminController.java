...
//   }
   ...
   // 자유게시판 목록(어드민)
   @RequestMapping(value = "/service/adminFreeboardList")
   public ModelAndView list(@RequestParam(defaultValue = "title") String searchOption,
         @RequestParam(defaultValue = "") String keyword, @RequestParam(defaultValue = "1") int curPage,
         HttpSession session) throws Exception {

      // 레코드 갯수 계산
      int count = bService.countArticle(searchOption, keyword);
      ...
      List<BoardVO> list = bService.list(start, end, searchOption, keyword);
      ...
      mav.setViewName("admin/service/adminFreeboardList");
   ...
   // 자유게시판 조회(어드민)
   @RequestMapping(value = "/service/adminFreeboardView", method = RequestMethod.GET)
   public ModelAndView getView(@RequestParam int fno, @RequestParam int curPage, @RequestParam String searchOption,
      ...
      bService.increaseViewcnt(fno, session);
      ModelAndView mav = new ModelAndView();
      mav.setViewName("admin/service/adminFreeboardView");
      mav.addObject("view", bService.read(fno));
   ...
   public String admindelete(@RequestParam int fno) throws Exception {

      bService.delete(fno);
      return "redirect:/admin/service/adminFreeboardList";
   }

   // 자유게시판 댓글목록
   @ResponseBody
   @RequestMapping(value = "/service/replyList", method = RequestMethod.GET)
   ...
   public void replyDelete(ReplyVO vo, HttpSession session) throws Exception {         
      RepService.adminReplyDelete(vo);
   }
