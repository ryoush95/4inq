		...
		<section id="container">
			...
			<div id="container_box">
				...
				<form role="form" method="post" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="inputArea">
						<label>1차 분류</label> <select class="category1" required="required">
							<option value="">1차</option>
						</select> <label>2차 분류</label> <select class="category2" name="cateCode" required="required">
					...
					<div class="inputArea">
						<label for="iname">상품명</label> <input type="text" id="iname"
							name="iname" required="required"/>
					</div>
					
					<div class="inputArea">
						<label for="pnum">생산자번호</label> <input type="text" id="pnum"
							name="pnum" required="required"/>
					</div>					
					...
					<div class="inputArea">
						...
						<textarea rows="5" cols="50" id="iintroduce" name="iintroduce" required="required"></textarea>
					</div>
							...
							$("option:selected", this)
									.each(
											function() {
												...
												cate2Select
														.append("<option value='" + selectVal + "'>2차</option>");
