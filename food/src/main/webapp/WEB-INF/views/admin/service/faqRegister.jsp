						...
						<div class="col-lg-8">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form id="boardFrm" name="form1"
										action="/admin/service/faqRegister" method="post">
										<div class="row form-group">
											<label class="col-lg-2">질문</label>
											<div class="col-lg-8">
												<input type="text" class="form-control" id="faq_title"
													name="faq_title" min="1" max="3">
											</div>
										</div>
										<div class="row form-group">
											<label class="col-lg-2">답변</label>
											<div class="col-lg-8">
												<textarea class="form-control" id="faq_content"
									...
									<button class="btn btn-outline btn-primary"
										onclick="location.href='/admin/index'">취소</button>
								</div>
							</div>
						</div>
					</div>
